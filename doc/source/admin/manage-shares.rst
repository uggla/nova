...
/servers/{server_id}/shares API, and specify the share_id of the share you
...
a tag, the share_id will be used instead.
...
/servers/{server_id}/shares/{share_id} API, and specify the share_id of the
...
GET /servers/{server_id}/shares/{share_id} API, and specify the share_id of
