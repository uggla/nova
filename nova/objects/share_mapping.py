...
SHARE_MAPPING_PROTO = ['NFS', 'CEPHFS']
...
class ShareMapping(base.NovaPersistentObject, base.NovaObject):
    ...
    fields = {
        ...
        'share_proto': fields.EnumField(valid_values=SHARE_MAPPING_PROTO),
    }
    ...
    def get_by_instance_uuid_and_share_id(
        ...
        # We should have a list with only one element as a share can be
...
class ShareMappingLibvirt(ShareMapping, metaclass=ABCMeta):
    ...
    def from_share_mapping(cls, context, instance, share_mapping):
        ...
        class_name = getattr(
            ...
            'VolumeDriver')
        share_mapping_libvirt.libvirt_driver = class_name(instance.host)
...
class ShareMappingLibvirtCephFS(ShareMappingList):
    pass
