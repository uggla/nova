    ...
    def create(self, req, server_id, body):
        ...
        with nova_context.target_cell(context, im.cell_mapping) as cctxt:
            ...
            try:
                ...
                share_mapping = sm.ShareMapping(cctxt)
    ...
    def delete(self, req, server_id, id):
        ...
        with nova_context.target_cell(context, im.cell_mapping) as cctxt:
            ...
            try:
                ...
                smlist = sm.ShareMappingList.get_by_share_id(
                    cctxt, share_mapping.share_id)
                for share_mapping in smlist:
                    host_sm_instance = self.compute_api.get(
                        cctxt, share_mapping.instance_uuid).host
                    if host_sm_instance == instance.host:
                        nb_instances_on_compute += 1
                if nb_instances_on_compute < 2:
