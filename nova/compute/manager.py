...
class ComputeManager(manager.Manager):
    ...
    def _get_share_info(self, context, instance):
        ...
        for share_mapping in objects.ShareMappingList.get_by_instance_uuid(
            ...
            if share_mapping.status == fields.ShareMappingStatus.ATTACHING:
                ...
                LOG.error(
                    ...
                    "still in attaching state. Setting the instance "
                    "in error.",
            ...
            elif share_mapping.status == fields.ShareMappingStatus.ERROR:
                LOG.error(
    ...
    def mount_share(self, context, instance, share_mapping):
        ...
        def _mount_share(context, instance, share_mapping):
            ...
            try:
                ...
                _set_share_mapping_status(fields.ShareMappingStatus.INACTIVE)

            except (
                exception.ShareNotFound,
                exception.ShareProtocolUnknown,
                exception.ShareAccessGrantError,
                exception.ShareMountError,
            ) as e:
                _set_share_mapping_status(fields.ShareMappingStatus.ERROR)
