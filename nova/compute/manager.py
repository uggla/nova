...
class ComputeManager(manager.Manager):
    ...
    def _reboot_instance(self, context, instance, block_device_info,
        ...
        try:
            ...
            if reboot_type == "HARD" and is_share_error(share_info):
    ...
    def deny_share(self, context, instance, share_mapping):
        ...
        def _deny_share(context, instance, share_mapping):
            def check_share_usage(context, share_id):
                share_mappings = (
                ...
                return not all(
                    [
                        (share.status == "inactive" or share.status == "error")
    ...
    def _set_share_mapping_status(seld, share_mapping, status):
