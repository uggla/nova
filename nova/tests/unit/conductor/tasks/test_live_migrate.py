...
class LiveMigrationTaskTestCase(test.NoDBTestCase):
    ...
    def test_check_can_migrate_pci(self, mock_get_pci):
        ...
        # Simulate we have a flavor based request and a
        # device non live_migratable.
        mock_get_pci.return_value.objects[0].extra_info = {
            "live_migratable": "false"
        }
        _assert_precheck_error(
            "non live-migratable related PCI devices for "
