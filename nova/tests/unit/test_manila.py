...
class ManilaTestCase(BaseManilaTestCase, test.NoDBTestCase):
    ...
    def test_manilaclient_fails_unsupported_microversion(self):
        ...
        self.assertRaises(exception.UnsupportedManilaAPIVersion,
                          self.create_client,
                          '50.0')
    ...
    def test_get_access_id(self):
        ...
        self.requests.get(self.URL + '/share-access-rules?share_id=1234',
                          json={'access_list': s})
        access = self.api.get_access_id(self.context,
                                        '1234',
                                        'ip',
                                        '0.0.0.0/0',
                                        '2.45')
    ...
    def test_get_access_id_not_existing(self):
    ...
    def test_allow_access(self):
        ...
        self.requests.post(self.URL + '/shares/1234/action',
                          json={'access': s})
        access = self.api.allow(self.context,
                                        '1234',
                                        'ip',
                                        '0.0.0.0/0',
                                        'rw'
    ...
    def test_allow_access_fails_already_exists(self):
        ...
        self.assertIn(
            'Invalid input received: Share access ip:192.168.0.1/32 exists',
            exc.message)
    ...
    def test_deny_access_fails_id_missing(self):
        """Tests that we fail if access_id is missing.
        """
        s = self.stub_share(id='1234')
        self.requests.get(self.URL + '/shares/1234', json={'share': s})
        # Mock the access_list
        ...
        exc = self.assertRaises(exception.AccessNotFound,
                self.api.deny,
                self.context,
                '1234',
                'ip',
