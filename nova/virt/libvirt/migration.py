...
def get_updated_guest_xml(instance, guest, migrate_data, get_volume_config,
    ...
    # Then, if dst_cpu_shared_set_info is None, it means that there is no
    # cpu_shared_set configuration on the destination host.
    if (
        'dst_cpu_shared_set_info' in migrate_data and
        migrate_data.dst_cpu_shared_set_info is None
    ):
    ...
    if (
        'dst_cpu_shared_set_info' in migrate_data and
        migrate_data.dst_cpu_shared_set_info is not None
    ):
