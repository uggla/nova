...
from nova.objects import share_mapping as osm
...
class LibvirtDriver(driver.ComputeDriver):
    ...
    def _hard_reboot(self, context, instance, network_info,
        ...
        if share_info is None:
            share_info = osm.ShareMappingList()
        ...
        share_info = share_info.convert_to_driver(context, instance)
    ...
    def mount_share(self, context, instance, share_mapping):
        try:
            share_mapping_drv = osm.ShareMappingLibvirt.from_share_mapping(
                context, instance, share_mapping)
            share_mapping_drv.mount()
        except exception.ShareMountError as e:
            # Log that error happened in the driver part
            LOG.error(e.message)
            raise
    ...
    def _get_guest_config(self, instance, network_info, image_meta,
        ...
        self._guest_add_virtiofs_for_share(guest, share_info)
    ...
    def _build_device_metadata(self, context, instance):
        ...
        shares = osm.ShareMappingList.get_by_instance_uuid(
            context, instance.uuid
        )
    ...
    def _guest_add_virtiofs_for_share(self, guest, share_info):
